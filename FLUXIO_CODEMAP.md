# FLUXIO_CODEMAP.md
> Commit: 4e4c6d811546  |  Generado: 2026-06-05 21:55  |  Roadmap: 29/107 completados  |  Archivos totales: 695
...
|---|---|---|---|
| 30a-1 | Foundation — Typography TextAppearances | SIGUIENTE | `typography.xml (rework)` |
| 30a-2 | Foundation — Dimens | pendiente | `dimens.xml (rework)` |
| 30b-1 | Foundation — Colors paleta | pendiente | `colors.xml (rework)` |
| 30b-2 | Foundation — Themes | pendiente | `themes.xml (rework)` |
| 30c-1 | Foundation — Eliminar CookieImageView | pendiente | `CookieImageView.kt + layouts afectados (rework)` |
| 30c-2 | Foundation — Icon states | pendiente | `res/drawable/ic_*.xml (rework)` |
| 30d-1 | Foundation — Style rename script | pendiente | `61 archivos de estilo (rework)` |
| 30e-1 | Player — Layout XML | pendiente | `fragment_playback_panel.xml (rework)` |
| 30e-2 | Player — Controles y datos | pendiente | `PlaybackPanelFragment.kt (rework)` |
| 30e-3 | Player — Secundarios y tabs | pendiente | `PlaybackPanelFragment.kt (rework)` |
| 30e-4 | Player — Fast Seek y Swipe Indicator | pendiente | `FastSeekOverlay.kt (nuevo), PlayerSwipeIndicatorOverlay.kt` |
...
|---|---|---|---|
| **Codigo principal** | CI & Config | Material Components | Playback & Audio DSP | Lyrics | Statistics | 88 | [CODEMAP_part1.md](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part1.md) |
| **UI & Features** | UI Details/Library/Search/Settings | Tags | Backup | Image | Music/Data | Lists | Widgets | App Root | Otros | 207 | [CODEMAP_part2.md](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part2.md) |
| **Resources** | Drawables (XML vectoriales) | Layouts | Values | Preferences XML | Menus | Navigation | Other | 243 | [CODEMAP_part3.md](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part3.md) |
| **Fastlane / Metadata** | Descripciones de Play Store / F-Droid en todos los idiomas | 157 | [CODEMAP_part4.md](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part4.md) |

---

## Detalle por parte

### Part 1 — [Codigo principal](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part1.md) (88 archivos)
...
### Part 2 — [UI & Features](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part2.md) (207 archivos)
...
### Part 3 — [Resources](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part3.md) (243 archivos)
...
### Part 4 — [Fastlane / Metadata](https://raw.githubusercontent.com/Anasimandro10/fluxio/4e4c6d811546283883c02406f000a4445538dd0c/FLUXIO_CODEMAP_part4.md) (157 archivos)
