...
val FluxioTypography = Typography(
...
val LocalFluxioColors = staticCompositionLocalOf<FluxioColors> {
    error("No FluxioColors provided")
}
...
fun FluxioTheme(
    ...
    CompositionLocalProvider(
        LocalFluxioColors provides fluxioColors
    ) {
        MaterialTheme(
            colorScheme = colorScheme,
            typography = FluxioTypography,
            content = content
        )
    }
}
